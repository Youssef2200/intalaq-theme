...
var BlsCreateMapStoreLocation = (function () {
    return {
        init: function () {
            var token = typeof window !== 'undefined' && window.BlsMapboxAccessToken;
            if (!token) {
                console.warn('Store locator: set your Mapbox public token in the Store location section settings.');
                return;
            }
