...
name: ui-ux-pro-max
description: >-
  UI/UX design intelligence for Shopify themes (Liquid, assets/*.css, theme settings). Use when designing or refactoring storefront UI, accessibility, typography, or color. Always run commands from the theme repository root; script path is .cursor/skills/ui-ux-pro-max/scripts/search.py. For stack guidance default to html-tailwind and translate utilities into existing theme CSS variables and section patterns—not a React codebase.
---
